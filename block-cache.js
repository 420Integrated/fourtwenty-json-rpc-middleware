...
// `<nil>` comes from https://github.com/420integrated/go-420coin/issues/16925
...
class BlockCacheStrategy {
  ...
  canCacheResult (payload, result) {
    ...
    if (['fourtwenty_getTransactionByHash', 'fourtwenty_getTransactionReceipt'].includes(payload.method)) {
