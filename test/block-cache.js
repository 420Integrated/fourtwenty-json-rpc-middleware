...
cacheTest('getBlockForNumber for latest then block 0', [{
  method: 'fourtwenty_getBlockByNumber',
  params: ['latest'],
}, {
  method: 'fourtwenty_getBlockByNumber',
  params: ['0x0'],
...
cacheTest('getStorageAt for same block should cache', [{
  method: 'fourtwenty_getStorageAt',
...
//   method: 'fourtwenty_getTransactionByHash',
